...
class IndiaLocations {
  static const Map<String, List<String>> stateDistricts = {
    ...
    'West Bengal': [
      'Kolkata',
      'Howrah',
      'North 24 Parganas (Barasat/Bidhannagar/Salt Lake)',
      ...
      'Bankura',
      'Purulia',
      'Birbhum (Suri/Bolpur/Santiniketan)',
      'Kalimpong',
      'Kanchrapara',
      'Habra',
      'Bhatpara',
  ...
  static String? resolveDistrictForCity(String cityOrLocality, String state) {
    ...
    final stateList = stateDistricts.entries
        .firstWhere(
    ...
    for (final item in stateList) {
      if (item.toLowerCase() == cleanCity ||
          item.toLowerCase().startsWith('$cleanCity ')) {
