...
void main() {
  ...
  group('Customer Search Screen & Navigation Tests', () {
    testWidgets('CustomerSearchScreen displays Header, Location, SearchBar, Chips, and Salon Cards', (tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: CustomerSearchScreen(
            initialLocation: 'Bhubaneswar, Odisha',
          ),
        ),
      );
    ...
    testWidgets('Tapping Home Search Bar navigates directly to CustomerSearchScreen', (tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
    ...
    testWidgets('Tapping See all on Nearby Salons navigates to CustomerSearchScreen', (tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
