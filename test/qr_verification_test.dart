...
void main() {
  ...
  group('SalonQueue QR Verification Suite', () {
    test('TEST 1: Owner generates SalonQueue QR -> User scans it -> VALID', () async {
    ...
    test('TEST 2: User scans unrelated QR (UPI, Wi-Fi, WhatsApp) -> INVALID -> rejected', () async {
    ...
    test('TEST 3: User scans random website URL QR -> INVALID -> rejected', () async {
    ...
    test('TEST 4: User scans modified/tampered/fake SalonQueue payload -> INVALID -> rejected', () async {
    ...
    test('TEST 5: Two different SalonQueue salons have different QR codes -> open corresponding salon', () async {
      const salonId1 = '11111111-1111-1111-1111-111111111111'; // Royal Cuts
      const salonId2 = '22222222-2222-2222-2222-222222222222'; // Scissors & Combs
    ...
    test('TEST 6: Expired/inactive/non-existent salon QR -> rejected', () async {
      const ghostSalonId = '00000000-0000-0000-0000-000000000000';
      final rawGhostQr = QrPayloadService.generateSalonQrPayload(salonId: ghostSalonId);
