...
void main() {
  group('Supabase Configuration & Connectivity Diagnostics Tests', () {
    test('AppConfig handles empty and valid URLs cleanly', () {
      ...
      expect(
        AppConfig.supabaseHostname,
        equals('ktabfbscrehhdstggjzp.supabase.co'),
      );
    });

    test(
      'SupabaseConfig diagnostics verify configured host connectivity',
      () async {
    ...
    test(
      'AuthRepository translates network and DNS host lookup errors to user friendly messages',
      () {
