...
void main() {
  group('Issue 1: Customer Side Service Category Chips Tests', () {
    ...
    testWidgets('Every service category chip displays its name clearly and visibly', (tester) async {
  ...
  group('Issue 2: Owner Profile Delete Photo Tests', () {
    ...
    testWidgets('Delete photo button shows confirmation dialog and removes photo on confirmation', (tester) async {
      final authService = AuthService(null);
      ...
      expect(find.text('Are you sure you want to remove your profile photo?'), findsOneWidget);
